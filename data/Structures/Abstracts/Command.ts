import { BaseApplicationCommandOptionsData, PermissionResolvable, ApplicationCommandOptionType, EmbedData } from "discord.js";
import {ClientInteraction, ClientMessage} from "@Client/Message";
import {colors} from "@db/Message";
...
export abstract class Command {
    ...
    public isSlash: boolean = true;
    public isGuild: boolean = true;
